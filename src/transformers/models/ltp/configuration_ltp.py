...
class LTPConfig(PretrainedConfig):
    ...
    Args:
        ...
        force_dequant (:obj:`str`, `optional`, defaults to :obj:`"none"`):
            ...
            default, it is set as :obj:`"none"`, which does not dequantize any layers. Please specify :obj:`"gelu"`,
        ...
        prune_mode (:obj:`bool`, `optional`, defaults to :obj:`False`):
            Whether to prune the model or not.
        token_keep_rate (:obj:`float`, `optional`, defaults to 1):
            The fraction of tokens to keep unmasked at the end of the final module. The number of tokens remaining is
